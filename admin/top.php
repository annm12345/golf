      ...
      <nav class="navbar">
        <div class="container">
          ...
          <ul class="navbar-list">
            ...
            <li>
              <a href="member.php" class="navbar-link icon-box">
                <span class="material-symbols-rounded  icon">Man</span>

                <span>member</span>
              </a>
            </li>
            <li>
              <a href="scorekeeper.php" class="navbar-link icon-box">
                <span class="material-symbols-rounded  icon">move</span>
